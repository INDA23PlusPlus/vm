...
pub const ConstChecker = @import("ConstChecker.zig");
...
pub fn compile(
    ...
    comp._constcheck = try ConstChecker.init(&comp._ast, &comp._symtab, diagnostics, allocator);
    errdefer comp._lexer.deinit();
    errdefer comp._ast.deinit();
    errdefer comp._parser.deinit();
    errdefer comp._symtab.deinit();
    errdefer comp._constcheck.deinit();
