...
pub const Node = union(enum) {
    ...
    number: Token,
    unit: Token,
    print: struct { tok: []const u8, expr: usize },
    println: struct { tok: []const u8, expr: usize },
    compound: struct { discard: usize, keep: usize },
    list: struct { leading_brk: []const u8, items: ?usize },
    ...
    struct_: struct { leading_brc: []const u8, fields: ?usize },
